# autobot  [![Build Status](https://travis-ci.org/rogrs/autobot.svg?branch=master)](https://travis-ci.org/rogrs/autobot) [![Dependency Status](https://david-dm.org/rogrs/autobot.svg)](https://david-dm.org/rogrs/autobot) [![devDependency Status](https://david-dm.org/rogrs/autobot/dev-status.svg)](https://david-dm.org/rogrs/autobot#info=devDependencies) [![peerDependency Status](https://david-dm.org/rogrs/autobot/peer-status.svg)](https://david-dm.org/rogrs/autobot#info=peerDependencies) [![peerDependency Status](https://david-dm.org/rogrs/autobot/peer-status.svg)](https://david-dm.org/rogrs/autobot#info=peerDependencies) [![codecov](https://codecov.io/gh/rogrs/autobot/branch/master/graph/badge.svg)](https://codecov.io/gh/rogrs/autobot)
...
To optimize the autobot application for production, run:
