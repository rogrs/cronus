...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "autobot@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "autobot API";

        private String description = "autobot API documentation";
