...
export class PlanoService {
    ...
    private resourceSearchUrl = SERVER_API_URL + 'api/_search/planos';
     ...
     */
    private convertItemFromServer(json: any): Plano {
        const entity: Plano = Object.assign(new Plano(), json);
        return entity;
    }
